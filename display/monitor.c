...
#ifdef USE_DISPLAY_NUM
# define WINDOWPOS_X SDL_WINDOWPOS_CENTERED_DISPLAY(USE_DISPLAY_NUM)
# define WINDOWPOS_Y SDL_WINDOWPOS_CENTERED_DISPLAY(USE_DISPLAY_NUM)
#else
# define WINDOWPOS_X SDL_WINDOWPOS_UNDEFINED
# define WINDOWPOS_Y SDL_WINDOWPOS_UNDEFINED
#endif
